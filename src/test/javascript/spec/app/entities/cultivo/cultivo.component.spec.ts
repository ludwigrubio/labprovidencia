...
import { CultivoComponent } from 'app/entities/cultivo/cultivo.component';
import { CultivoService } from 'app/entities/cultivo/cultivo.service';
import { Cultivo } from 'app/shared/model/cultivo.model';

describe('Component Tests', () => {
  describe('Cultivo Management Component', () => {
    let comp: CultivoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CultivoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cultivos && comp.cultivos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
