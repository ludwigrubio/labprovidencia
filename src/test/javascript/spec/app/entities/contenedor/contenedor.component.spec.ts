...
import { ContenedorComponent } from 'app/entities/contenedor/contenedor.component';
...
describe('Component Tests', () => {
  describe('Contenedor Management Component', () => {
    let comp: ContenedorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ContenedorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contenedors && comp.contenedors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
