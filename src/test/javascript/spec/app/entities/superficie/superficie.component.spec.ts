...
import { SuperficieComponent } from 'app/entities/superficie/superficie.component';
...
describe('Component Tests', () => {
  describe('Superficie Management Component', () => {
    let comp: SuperficieComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SuperficieComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.superficies && comp.superficies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
