...
import { RecepcionComponent } from 'app/entities/recepcion/recepcion.component';
...
describe('Component Tests', () => {
  describe('Recepcion Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.recepcions && comp.recepcions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
