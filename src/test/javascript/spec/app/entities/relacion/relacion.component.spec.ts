...
import { RelacionComponent } from 'app/entities/relacion/relacion.component';
...
describe('Component Tests', () => {
  describe('Relacion Management Component', () => {
    let comp: RelacionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RelacionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.relacions && comp.relacions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
