...
export class ProcesoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.procesoService
      ...
      .subscribe(
        (res: HttpResponse<IProceso[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInProcesos(): void {
    this.eventSubscriber = this.eventManager.subscribe('procesoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProceso[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
